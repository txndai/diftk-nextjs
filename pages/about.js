  ...
  return (
    <Layout>
      <div className="container flex flex-col items-center justify-center px-5 py-24 mx-auto md:w-5/6">
        <article id='aboutUsText' className=''>
          <h1 className="mt-4 text-5xl font-bold text-center underline-custom">
              Our Mission
          </h1>
          <p className='prose lg:prose-lg'>To assist in alleviating the plight of the underprivileged children in the Zimbabwean community through enthusiastic service.</p>
          <h1 className="mt-4 text-5xl font-bold text-center underline-custom">
              Our Vision
          </h1>
          <p className='prose lg:prose-lg'>To become a youth organisation recognised both nationally and internationally, as one which puts the basic needs of children first, and one which has a positive impact in ably assisting children realise their goals through its active and innovative participation.</p>
          <h1 className="mt-4 text-5xl font-bold text-center underline-custom">
              Our Objectives
          </h1>
          <p className='prose lg:prose-lg'>
            <ul>
              ...
              <li>As an organisation, to visit children in institutions, such as orphanages, based in local communities on a regular basis and spend time with them and help them feel cared for and loved.<br/>
              -Raise awareness through mediums such as social platforms to highlight the current living conditions of children in child care institutions in the Zimbabwean community.</li>
            </ul>
          </p>
          <h1 className="mt-4 text-5xl font-bold text-center underline-custom">
              Purpose & Goals
          </h1>
          <p className='prose lg:prose-lg'>The Do it for the Kids Organisation shall exist to both educate and garner support from the Zimbabwean community and the world at large on issues and needs relating to the condition of underprivileged children around the country, and specifically relating these issues to the work of raising the brand of philanthropy and more importantly service for the glory of God.</p>
          <h1 className="mt-4 text-5xl font-bold text-center underline-custom">
