    ...
    return (
        <Layout>
            <div className="container flex flex-col items-center justify-center px-5 py-24 mx-auto md:w-5/6">
                ...
                <p className='prose lg:prose-lg'>Please fill in the form below or email your article to <a href="mailto:doit4thekids@gmail.com">doit4thekids@gmail.com</a></p>

                <form className="p-8 mx-auto my-5 rounded lg:w-1/2 md:w-2/3 bg-secondary" name="blogger submission" data-netlify="true" method='POST' data-netlify-honeypot="bot-field">
                    <input type="hidden" name="bot-field" />
                    <input type="hidden" name="form-name" value="blogger submission" />
                    ...
                    <div className="w-2/3 p-2 mx-auto">
                        <textarea className="w-full h-48 p-2 m-1 text-sm appearance-none bg-background focus:outline-none focus:placeholder-background" placeholder="Tell us what you'd like to write about." type="text" name='message' ></textarea>
                    </div>
